...
%**************************************************************************
function model = em_algorithm_uvrotation(matrixID, params, model, stats)
...
% Plot V and U
figure();
scatter(V(1:10,1),V(1:10,2)); hold on; 
scatter(U(1:10,1),U(1:10,2),'r');


%% Apply eigenvoice rotation
Sx = V*U'; % cross covariance between eigensession and eigenvoice matrices.

[Sxcol, ~, Sxrow] = svd(Sx);

RotationMatrix = Sxrow*Sxcol';
